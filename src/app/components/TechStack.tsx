    ...
    <section className="py-16 px-6 bg-slate-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-slate-900 mb-4">Technologies I Work With</h3>
          <p className="text-slate-600">Core tools and frameworks in my development workflow</p>
        </div>
